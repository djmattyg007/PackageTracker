...
$di->types["MattyG\\DependencyTracker\\Cli\\Formatter"] = $di->lazyGet("cli_formatter");
...
$di->set("cli_formatter", $di->lazyNew("MattyG\\DependencyTracker\\Cli\\Formatter", array("isPosix" => $di->lazyGetCall("cli_stdout", "isPosix"))));
//$di->set("cli_formatter", $di->lazyNew("Aura\\Cli\\Stdio\\Formatter"));
...
$di->types["MattyG\\DependencyTracker\\Cli\\Stdio"] = $di->lazyGet("cli_stdio");
$di->set(
    "cli_stdio",
    $di->lazyNew(
        "MattyG\\DependencyTracker\\Cli\\Stdio",
        array(
